...
const BudgetItem = ({ budget }) => {
  return (
    <div className="p-5  rounded-lg border hover:shadow-md cursor-pointer">
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center  gap-2">
          ...
          <div className="">
            ...
            <h2 className="text-sm text-muted-foreground">{budget.totalItems} Item</h2>
          </div>
        </div>
      ...
      <div className="mt-5">
        ...
        <div className="w-full h-2 rounded-full bg-gray-300">
          <div className="w-[40%] h-2 rounded-full bg-blue-500"></div>
        </div>
      </div>
    </div>
  );
